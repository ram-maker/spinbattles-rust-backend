...
/// # path.push("gs_correlation-tests/fo-struct-doc.log");
...
impl FileStream {
    ...
    /// # };
    /// # let mut path = std::env::temp_dir();
    /// # path.push("gs_correlation-tests/fo-set_log_file_path-doc.log");
    /// # let path = &path.to_str().unwrap().to_string();
    ...
    /// # };
    /// # let mut path = std::env::temp_dir();
    /// # path.push("gs_correlation-tests/fo-out-doc.log");
    /// # let path = &path.to_str().unwrap().to_string();
    /// # let mut formatter = LogFormatter::default();
    /// # let mut file_output = FileStream::default();
    ///
    ...
    /// # };
    /// # let mut path = std::env::temp_dir();
    /// # path.push("gs_correlation-tests/fo-set_max_buffer_size-doc.log");
    /// # let path = &path.to_str().unwrap().to_string();
    /// # let mut formatter = LogFormatter::default();
    /// # let mut file_output = FileStream::default();
    /// // Set the log file path **first**
    ...
    /// # };
    /// # let mut path = std::env::temp_dir();
    /// # path.push("gs_correlation-tests/fo-enable-doc.log");
    /// # let path = &path.to_str().unwrap().to_string();
    /// # let formatter = LogFormatter::default();
    /// # let mut file_output = FileStream::default();
    ///
